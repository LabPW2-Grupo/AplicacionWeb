...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'roles_key' => ['type' => 'index', 'columns' => ['roles_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'roles_key' => ['type' => 'foreign', 'columns' => ['roles_id'], 'references' => ['roles', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'roles_id' => 1,
                'created' => '2021-12-12 08:53:32',
                'modified' => '2021-12-12 08:53:32',
            ],
        ];
        parent::init();
    }
